...
#-------------------------------------------------------------------------------------------------------
def conll_sentence_esp(conll_file):
    """CoNLL2003 sentences from file
...
def conll_words_esp(conll_file):
    """CoNLL2003 words from file
    ...
    sent, pos, entity = conll_sentence_esp(conll_file)
    # print(pos[0])
    for se in sent:
        for w in se:
            all_words.append(w)
    ...
    return all_words, all_pos, all_entities
